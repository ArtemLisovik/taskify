...
import { selectFilters, selectActiveFilter } from '../model/FilterSelect'
import { activeFilter } from '../model/FIltersSlice'
import { fetchAllFilters } from '../model/FiltersThunk'
import { FiltersType } from '../types/IFilter'
...
export const Filters: FC = () => {
    ...
    const handleChange = (filter: FiltersType) => {
    ...
    return (
        <div className="filters">
            ...
            <div className="filters__bottom">
                <div className="filters__bottom-wrapper">
                    ...
                    <select className='filters__bottom-filters'>
                        <option disabled className="filters__bottom-option">Quick filters...</option>
            ...
            <div className="filters__status">
                ...
                {filters.length && filters?.map(({ filter, id }) => {
                    return <Button
                        key={id}
